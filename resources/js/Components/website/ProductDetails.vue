            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="slider-box w-full h-full max-lg:mx-auto mx-0">
                    <div class="main-img mb-3 min-[400px]:mb-8">
                        <img src="/Images/product1.webp" alt="Summer Travel Bag image" class="max-lg:mx-auto">
                    </div>
                    <div class="grid grid-cols-5 gap-3 max-lg:max-w-[608px] max-lg:mx-auto">
                        <img src="/Images/short1.webp" alt="Summer Travel Bag image"
                            class="w-full max-w-[112px] aspect-square cursor-pointer rounded-xl transition-all duration-500 border hover:border-indigo-600">
                        <img src="/Images/short1.webp" alt="Summer Travel Bag image"
                            class="w-full max-w-[112px] aspect-square cursor-pointer rounded-xl transition-all duration-500 border hover:border-indigo-600">
                        <img src="/Images/short1.webp" alt="Summer Travel Bag image"
                            class="w-full max-w-[112px] aspect-square cursor-pointer rounded-xl transition-all duration-500 border hover:border-indigo-600">
                ...
                <div class="flex justify-center items-center px-2">
                    <div class="pro-detail w-full max-lg:max-w-[608px] lg:pl-8 xl:pl-16 max-lg:mx-auto max-lg:mt-8">
                        <div class="flex items-center justify-between gap-6 mb-6">
                            <div class="text">
                                <h2 class="font-manrope font-bold text-2xl leading-10 text-gray-900 mb-2">
                                    Yellow Summer
                                    Travel
                                    Bag
                                </h2>
                                <p class="font-normal text-sm text-gray-500">ABS LUGGAGE</p>
                            </div>
                        ...
                        <div class="flex flex-col min-[400px]:flex-row min-[400px]:items-center mb-2 gap-y-3">
                            <div class="flex items-center">
                                <h5 class="font-manrope font-semibold text-xl leading-9 text-gray-900 ">$
                                    199.00 </h5>
                                <span class="ml-3 font-semibold text-sm text-indigo-600">30% off</span>
                            </div>
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-2 max-w-sm">
                        ...
                        <p class="font-medium text-lg text-gray-900 mb-1">Size (KG)</p>
                        <div class="grid grid-cols-2 min-[400px]:grid-cols-4 gap-3 mb-4">
                            <button
                                class="border border-gray-200 whitespace-nowrap text-gray-900 text-xs leading-6 py-1 rounded-full px-5 text-center w-full font-semibold shadow-sm shadow-transparent transition-all duration-300 hover:bg-gray-50 hover:shadow-gray-300">Full
                                Set</button>
                            <button
                                class="border border-gray-200 whitespace-nowrap text-gray-900 text-xs leading-6 py-1 rounded-full px-5 text-center w-full font-semibold shadow-sm shadow-transparent transition-all duration-300 hover:bg-gray-50 hover:shadow-gray-300">
                                10 kg</button>
                            <button
                                class="border border-gray-200 whitespace-nowrap text-gray-900 text-xs leading-6 py-1 rounded-full px-5 text-center w-full font-semibold shadow-sm shadow-transparent transition-all duration-300 hover:bg-gray-50 hover:shadow-gray-300">
                                25 kg</button>
                        ...
                        <div class="flex items-center flex-col min-[400px]:flex-row gap-3 mb-3 min-[400px]:mb-8">
                            <div class=" flex items-center justify-center border border-gray-400 rounded-full">
                                <button
                                    class="group rounded-l-full px-2 py-[11px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
                                ...
                                <input type="text"
                                    class="border-y border-gray-200 outline-none text-gray-900 font-semibold text-lg w-full max-w-[40px] min-w-[32px] placeholder:text-gray-900 py-[8px]  text-center bg-transparent"
                                    placeholder="1">
                                <button
                                    class="group rounded-r-full px-2 py-[11px] border border-gray-200 flex items-center justify-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-50 hover:border-gray-300 hover:shadow-gray-300 focus-within:outline-gray-300">
                                    <svg class="stroke-gray-900 transition-all duration-500 group-hover:stroke-black"
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                        viewBox="0 0 22 22" fill="none">
                            ...
                            <button
                                class="group py-1.5 px-5 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-lg w-full flex items-center justify-center gap-2 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-indigo-300 hover:bg-indigo-100">
                        ...
                        <button
                            class="text-center w-full px-4 py-2 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-300">
                            Buy Now
                        </button>
                    </div>
                </div>
