    ...
    const categorySubmit = async => {
        form.post(route('categories.store'), {
            onSuccess: (Response) => {
                ...
                console.log(Response.props.categories);
                Object.assign(props.categories, Response.props.categories);
                        ...
                        <form @submit.prevent="categorySubmit">
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div class="sm:col-span-2">
                                    ...
                                    <TextInput v-model="form.name" type="text" placeholder="Type Category name"
                                        required=""></TextInput>
                                </div>
                                <div class="sm:col-span-2">
