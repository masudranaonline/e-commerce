...
<template>
    <AppLayout>
        ...
        <div class="bg-white py-4 mb-4 rounded-xl flex gap-4">
            ...
            <div id="dropdownBottom"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownBottomButton">
                    <li>
                        <Link :href="route('products.trashList')"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Recycle Bin</Link>
                    </li>
                    <li>
                        <a href="#"
