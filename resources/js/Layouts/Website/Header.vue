        ...
        <section class="bg-[#294A70]">
            <div class="mx-auto max-w-7xl p-4 md:py-6">
                <div class="grid md:grid-cols-3 gap-4">
                    <div class=" md:col-span-2 flex flex-col md:flex-row gap-4 items-center"><img src="../../../../public/Images/logo.png"
                            alt="Logo Anjin Metal Industries Ltd." class="block h-16">
